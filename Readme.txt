### Introduction
Bugün tesla, volvo gibi firmaların yaptığı  otonom sistemlere bir prototip oluşturmaya çalışalım. Bu sistemler genel anlamda algılama ve yönlendirme olacak şekilde iki parçadan oluşur. Şerit ve trafik ışıklarını algılama sistemlerini oluşturup burdan elde edilen verilere göre yönlendirme kısmını yapalım. Bu işlemler için ise Raspberry Pi 4 kontrol kartını kullanalım. (Raspberry Pi 3'te kullanılabilir.)
